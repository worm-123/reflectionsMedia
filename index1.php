...
<section class="container-fluid gradient">
	<div class="row">
		<div class="container_full background-flower">
			<div class="container">
				<div class="col-lg-6 col-md-6 col-sm-12 container_full responsiveClass"> 
					<div class="row">
						<div class="logo">
							<a href="index.php">
								<img src="media/img/logo_home.png" alt="Reflection Media" title="Reflection Media" class="logo_img">
							</a>
						</div>
						<div class="footer">
