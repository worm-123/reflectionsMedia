...
<div class="container-fluid">
    <div class="container">
        <div class="row">
            <div class="container">
                <div class="header">
                  <p class="navigationTxt text-center"><span class="border margin-top-10">Sitemaps</span></p>
                  <hr class="horzontal_line">
                       <div id="cont">
                            ...
                            <li class="lpage"><a href="http://flyingarrow.in/WebReflections/view/blog.php?page=4" title="http://flyingarrow.in/WebReflections/view/blog.php?page=4">http://flyingarrow.in/WebReflections/view/blog.php?page=4</a></li>
                            <li class="lpage last-page"><a href="http://flyingarrow.in/WebReflections/view/blog.php?page=5" title="http://flyingarrow.in/WebReflections/view/blog.php?page=5">http://flyingarrow.in/WebReflections/view/blog.php?page=5</a></li>
                            </ul></li>
                            </ul>
                    </div>
                </div>
